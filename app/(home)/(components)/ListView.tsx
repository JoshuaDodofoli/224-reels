        ...
        <section className="w-full mx-auto min-h-dvh pt-28">
            ...
            <div className="max-w-2xl mx-auto px-4 w-full">
                <div className="flex items-center justify-between border-b border-grey-300 pb-3 mb-1">
                    <span className="font-sans text-xs text-grey-400 uppercase tracking-widest">
                        Index
                    </span>
                    <span className="font-sans text-xs text-grey-400 uppercase tracking-widest flex-1 pl-8">
                        Title
                    </span>
                    {/* <span className="font-sans text-xs text-grey-400 uppercase tracking-widest">Type</span> */}
                    <span className="font-sans text-xs text-grey-400 uppercase tracking-widest  text-right">
                        Date
                    </span>
                </div>
                ...
                <ul>
                    {reels.map((reel, idx) => (
                        <li
                            key={reel.slug}
                            className="border-b border-grey-300"
                        >
                            <TransitionLink
                                ...
                                ref={
                                    ...
                                    }) as RefCallback<HTMLAnchorElement>
                                }
