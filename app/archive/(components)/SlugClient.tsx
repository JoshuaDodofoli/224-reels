        ...
        <div>
            <div className="relative z-10 min-h-screen bg-grey-200 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col">
                ...
                <div className="flex-1 flex flex-col justify-center w-full px-4 md:px-12">
                    ...
                    >
                        <div
                            className="fixed inset-0 z-100 bg-[#101010] pointer-events-none"
                            style={{
                        ...
                        >
                            <div
                                className={`absolute top-0 left-0 z-30 p-6 md:px-12 md:py-10 transition-[opacity,filter] ${
                                    showControls
                                        ? "opacity-100 blur-none pointer-events-auto duration-1000 ease-out"
                                        : "opacity-0 blur-md pointer-events-none duration-300 ease-in"
                                }`}
                            >
                            ...
                            <div
                                className={`absolute top-0 right-0 z-30 p-6 md:px-12 md:py-10 transition-[opacity,filter] ${
                                    showControls
                                        ? "opacity-100 blur-none pointer-events-auto duration-1000 ease-out"
                                        : "opacity-0 blur-md pointer-events-none duration-300 ease-in"
                                }`}
                            ...
                            {reel.video ? (
                                <>
                                    ...
                                    <Image
                                        ...
                                        fill
                                        priority
                                        sizes={isExpanded ? "100vw" : "(max-width: 768px) 100vw, 512px"}
                                        style={{ zIndex: 11 }}
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`pointer-events-none absolute inset-0 flex items-center justify-center transition-opacity duration-500 ${
                                                isExpanded ? "opacity-0" : !isPlaying || isCursorInVideo ? "opacity-100" : "opacity-0"
                                            }`}
                                        >
                                            <button
                                                type="button"
                                            ...
                                            >
                                                ...
                                                <svg
                                                    className={`absolute transition-all duration-300 ease-out translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 w-5 h-5 ${
                                                        !isPlaying ? "ml-1" : ""
                                                    }`}
                                                    viewBox="0 0 24 24"
                                                    fill="currentColor"
                                    ...
                                    <div
                                        className={`absolute inset-x-0 bottom-0 z-30 px-4 pb-6 md:px-6 transition-[opacity,filter] ${
                                            showControls
                                                ? "opacity-100 blur-none pointer-events-auto duration-1000 ease-out"
                                                : "opacity-0 blur-md pointer-events-none duration-300 ease-in"
                                        }`}
                    ...
                    <div className="mt-8 w-full max-w-lg mx-auto flex flex-col items-center text-center gap-8">
                        <p className="text-body font-sans text-grey-450">{reel.desc}</p>
                    </div>
                </div>
            </div>
